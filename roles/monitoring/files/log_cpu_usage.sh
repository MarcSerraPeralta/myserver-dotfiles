#!/bin/bash
LOGFILE_I="/home/marc/monitoring/data/cpu_use.csv"
LOGFILE_H="/home/marc/monitoring/data/cpu_use_last-hour.csv"
LOGFILE_D="/home/marc/monitoring/data/cpu_use_last-day.csv"
MAX_LINES_H=800
MAX_LINES_D=3000
